...
| `on_min_max_brightness`            | It puts the brightness to the minimum value if the light is off or at any other brightness; else it puts the brigtness to the maximum value.                                                                  |                                                         |
| `on_max_min_brightness`            | It puts the brightness to the maximum value if the light is off or at any other brightness; else it puts the brigtness to the minimum value.                                                                  |                                                         |
| `on_min_max_color_temp`            | It puts the color temp to the minimum value if the light is off or at any other color temp; else it puts the color temp to the maximum value.                                                                 |                                                         |
| `on_max_min_color_temp`            | It puts the color temp to the maximum value if the light is off or at any other color temp; else it puts the color temp to the minimum value.                                                                 |                                                         |
